...
namespace PriorityQueue
{
    ...
    /*public class Test
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Using Constructor 1");
            ...
            PQ.Add(new PriorityClass(7, "Omar"));
           ...
           Console.WriteLine("Using Constructor 2");

            PriorityClass[] PC = new PriorityClass[5];

            PC[0] = new PriorityClass(1, "Susan");
            PC[1] = new PriorityClass(3, "Hannah");
            PC[2] = new PriorityClass(3, "Tony");
            PC[3] = new PriorityClass(7, "Pranjal");
            PC[4] = new PriorityClass(1, "Alan");

            PQ = new PriorityQueue<PriorityClass>(PC);
